...
public class TwoPointers {
    ...
    private static void testMaxSumUsingTwoPointers1() {
        ...
        System.out.println("Test 1 - Max sum of subarray of size 3: arr=" + Arrays.toString(arr) + ", k=" + k);
    ...
    private static void testMaxSumUsingTwoPointers2() {
        ...
        int k = 3;
        int result = maxSumUsingTwoPointers(arr, k);
        System.out.println("Test 2 - Array length < k: arr=" + Arrays.toString(arr) + ", k=" + k);
    ...
    private static void testMaxSumUsingTwoPointers3() {
        ...
        int k = 2;
        int result = maxSumUsingTwoPointers(arr, k);
        System.out.println("Test 3 - Negative numbers: arr=" + Arrays.toString(arr) + ", k=" + k);
