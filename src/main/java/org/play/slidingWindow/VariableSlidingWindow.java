...
public class VariableSlidingWindow {
    ...
    /**
     * More Optimized as it left window jumps directly.
     * Check @longestSubstringWithNonRepeatingCharsUnOptimized LC 3 — Longest Substring Without
     * Repeating Characters Difficulty: Medium Companies: Amazon, Google, Meta, Microsoft, Bloomberg,
     * Adobe, Apple, Uber, Goldman Sachs, TikTok, Yandex (112 companies total)
     *
    ...
    /**
     * LC 209 — Minimum Size Subarray Sum Difficulty: Medium Companies: Google, Amazon, Microsoft,
    ...
    /**
     * LC 424 — Longest Repeating Character Replacement Difficulty: Medium Companies: Google, Amazon,
     * Microsoft, Meta, Bloomberg
     *
     * <p>Problem: Given a string string and an integer atmostCharReplacement, you can replace at most
    ...
    private static void testEmptyArray209() {
        ...
        System.out.println(
                "Test 1 - Empty array: nums=" + java.util.Arrays.toString(nums) + ", target=" + target);
        System.out.println(
    ...
    private static void testSingleElementGreaterOrEqual() {
        ...
        int result = minimumSizeSubarraySum(target, nums);
        System.out.println(
                "Test 2 - Single element >= target: nums="
    ...
    private static void testSingleElementLess() {
        ...
        int result = minimumSizeSubarraySum(target, nums);
        System.out.println(
                "Test 3 - Single element < target: nums="
                        + java.util.Arrays.toString(nums)
                        + ", target="
                        + target);
        System.out.println(
    ...
    private static void testMultipleElementsWithValidSubarray() {
        ...
        int result = minimumSizeSubarraySum(target, nums);
        System.out.println(
                "Test 4 - Multiple elements with valid subarray: nums="
                        + java.util.Arrays.toString(nums)
                        + ", target="
                        + target);
        System.out.println(
                "  Expected: 2, Got: " + result + ", " + (result == 2 ? "PASS" : "FAIL") + "\n");
    }
    ...
    private static void testSingleColorOnly() {
        ...
        System.out.println(
                "  Expected: 5, Got: " + result + ", " + (result == 5 ? "PASS" : "FAIL") + "\n");
    }
    ...
    private static void testMultipleColorsWithLongestSingle() {
        ...
        int result = maxFruitsIntoBasketOfSameColor(arr);
        System.out.println(
                "Test 2 - Multiple colors, longest single: arr=" + java.util.Arrays.toString(arr));
        System.out.println(
                "  Expected: 5, Got: " + result + ", " + (result == 5 ? "PASS" : "FAIL") + "\n");
    }
    ...
    private static void testAllSameCharacter() {
        ...
        System.out.println(
                "  Expected: 4, Got: " + result + ", " + (result == 4 ? "PASS" : "FAIL") + "\n");
    }
    ...
    private static void testNoReplacementNeeded() {
        ...
        int result = longestRepeatingCharReplacement(s, k);
        System.out.println(
                "Test 6 - No replacement needed (consecutive same): s=\"" + s + "\", k=" + k);
        System.out.println(
                "  Expected: 2, Got: " + result + ", " + (result == 2 ? "PASS" : "FAIL") + "\n");
    }
    ...
    /**
     * LC 930 — Binary Subarrays With Sum Difficulty: Medium Companies: Google, Amazon, Meta
     *
     * <p>Problem: Given a binary array nums and an integer goal, return the number of non-empty
     * subarrays with a sum equal to goal.
     *
     * <p>Why sliding window: Count subarrays with EXACTLY goal sum. Use Template 5: atMost(goal) -
     * atMost(goal - 1).
     *
     * @param nums
     * @param goal
   ...
   * Difficulty: Hard Companies: Google, Amazon, Meta, Microsoft, Apple, Uber, Bloomberg, Adobe, Oracle, LinkedIn
   *
   ...
   *
   * Input: s = "aaaaaaaaaaaabbbbbcdd", t = "abcdd" Output: "abbbbbcdd"
   *
   */
